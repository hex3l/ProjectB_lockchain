...
const DisputeStatusRow = ({
  ...
  payBuyer,
  paySeller,
}: OrderDto & { payBuyer?: (id: number) => void; paySeller?: (id: number) => void }) => {
            ...
            <Box className="flex flex-col md:flex-row space-x-2">
              ...
              <Box className="hidden md:flex flex-row space-x-3">
                <Box className="space-x-3">
                  <Button variant="contained" color="primary" onClick={() => payBuyer && payBuyer(id)}>
                    Pay buyer
                  </Button>
                  <Button variant="contained" color="secondary" onClick={() => paySeller && paySeller(id)}>
                    Pay seller
                  </Button>
                </Box>
              </Box>
